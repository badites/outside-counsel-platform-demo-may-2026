      ...
      {tab === "paste" && (
        <div className="space-y-3">
          ...
          <textarea
            ...
            className="w-full rounded-lg border border-gray-200 bg-white px-3 py-2.5 text-sm text-gray-900 placeholder:text-gray-400 focus:border-scg-400 focus:outline-none focus:ring-1 focus:ring-scg-400"
          />
          <button
